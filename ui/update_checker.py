...
LATEST_RELEASE_DOWNLOAD_PAGE_URL = "https://github.com/andirigible/wwplando/releases/latest"
LATEST_RELEASE_API_URL = "https://api.github.com/repos/andirigible/wwplando/releases/latest"
