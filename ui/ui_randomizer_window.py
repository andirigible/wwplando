...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Wind Waker Plandomizer", None))
        self.label.setText(QtWidgets.QApplication.translate("MainWindow", "Clean WW ISO", None))
        self.label_2.setText(QtWidgets.QApplication.translate("MainWindow", "Output Folder", None))
        self.output_folder_browse_button.setText(QtWidgets.QApplication.translate("MainWindow", "Browse", None))
        self.label_3.setText(QtWidgets.QApplication.translate("MainWindow", "Seed (optional)", None))
        self.generate_seed_button.setText(QtWidgets.QApplication.translate("MainWindow", "New seed", None))
        self.clean_iso_path_browse_button.setText(QtWidgets.QApplication.translate("MainWindow", "Browse", None))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("MainWindow", "Where Should Progress Items Appear?", None))
        self.progression_submarines.setText(QtWidgets.QApplication.translate("MainWindow", "Submarines", None))
        self.progression_platforms_rafts.setText(QtWidgets.QApplication.translate("MainWindow", "Lookout Platforms and Rafts", None))
        self.progression_short_sidequests.setText(QtWidgets.QApplication.translate("MainWindow", "Short Sidequests", None))
        self.progression_dungeons.setText(QtWidgets.QApplication.translate("MainWindow", "Dungeons", None))
        self.progression_long_sidequests.setText(QtWidgets.QApplication.translate("MainWindow", "Long Sidequests", None))
        self.progression_treasure_charts.setText(QtWidgets.QApplication.translate("MainWindow", "Sunken Treasure (From Treasure Charts)", None))
        self.progression_triforce_charts.setText(QtWidgets.QApplication.translate("MainWindow", "Sunken Treasure (From Triforce Charts)", None))
        self.progression_mail.setText(QtWidgets.QApplication.translate("MainWindow", "Mail", None))
        self.progression_spoils_trading.setText(QtWidgets.QApplication.translate("MainWindow", "Spoils Trading", None))
        self.progression_great_fairies.setText(QtWidgets.QApplication.translate("MainWindow", "Great Fairies", None))
        self.progression_puzzle_secret_caves.setText(QtWidgets.QApplication.translate("MainWindow", "Puzzle Secret Caves", None))
        self.progression_combat_secret_caves.setText(QtWidgets.QApplication.translate("MainWindow", "Combat Secret Caves", None))
        self.progression_free_gifts.setText(QtWidgets.QApplication.translate("MainWindow", "Free Gifts", None))
        self.progression_misc.setText(QtWidgets.QApplication.translate("MainWindow", "Miscellaneous", None))
        self.progression_minigames.setText(QtWidgets.QApplication.translate("MainWindow", "Minigames", None))
        self.progression_expensive_purchases.setText(QtWidgets.QApplication.translate("MainWindow", "Expensive Purchases", None))
        self.progression_big_octos_gunboats.setText(QtWidgets.QApplication.translate("MainWindow", "Big Octos and Gunboats", None))
        self.progression_eye_reef_chests.setText(QtWidgets.QApplication.translate("MainWindow", "Eye Reef Chests", None))
        self.groupBox_3.setTitle(QtWidgets.QApplication.translate("MainWindow", "Additional Randomization Options", None))
        self.randomize_starting_island.setText(QtWidgets.QApplication.translate("MainWindow", "Randomize Starting Island", None))
        self.randomize_charts.setText(QtWidgets.QApplication.translate("MainWindow", "Randomize Charts", None))
        self.randomize_dungeon_entrances.setText(QtWidgets.QApplication.translate("MainWindow", "Randomize Dungeon Entrances", None))
        self.keylunacy.setText(QtWidgets.QApplication.translate("MainWindow", "Key-Lunacy", None))
        self.label_for_sword_mode.setText(QtWidgets.QApplication.translate("MainWindow", "Sword Mode", None))
        self.sword_mode.setItemText(0, QtWidgets.QApplication.translate("MainWindow", "Start with Sword", None))
        self.sword_mode.setItemText(1, QtWidgets.QApplication.translate("MainWindow", "Randomized Sword", None))
        self.sword_mode.setItemText(2, QtWidgets.QApplication.translate("MainWindow", "Swordless", None))
        self.label_for_num_starting_triforce_shards.setText(QtWidgets.QApplication.translate("MainWindow", "Triforce Shards to Start With:", None))
        self.num_starting_triforce_shards.setItemText(0, QtWidgets.QApplication.translate("MainWindow", "0", None))
        self.num_starting_triforce_shards.setItemText(1, QtWidgets.QApplication.translate("MainWindow", "1", None))
        self.num_starting_triforce_shards.setItemText(2, QtWidgets.QApplication.translate("MainWindow", "2", None))
        self.num_starting_triforce_shards.setItemText(3, QtWidgets.QApplication.translate("MainWindow", "3", None))
        self.num_starting_triforce_shards.setItemText(4, QtWidgets.QApplication.translate("MainWindow", "4", None))
        self.num_starting_triforce_shards.setItemText(5, QtWidgets.QApplication.translate("MainWindow", "5", None))
        self.num_starting_triforce_shards.setItemText(6, QtWidgets.QApplication.translate("MainWindow", "6", None))
        self.num_starting_triforce_shards.setItemText(7, QtWidgets.QApplication.translate("MainWindow", "7", None))
        self.num_starting_triforce_shards.setItemText(8, QtWidgets.QApplication.translate("MainWindow", "8", None))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("MainWindow", "Convenience Tweaks", None))
        self.instant_text_boxes.setText(QtWidgets.QApplication.translate("MainWindow", "Instant Text Boxes", None))
        self.generate_spoiler_log.setText(QtWidgets.QApplication.translate("MainWindow", "Generate Spoiler Log", None))
        self.swift_sail.setText(QtWidgets.QApplication.translate("MainWindow", "Swift Sail", None))
        self.reveal_full_sea_chart.setText(QtWidgets.QApplication.translate("MainWindow", "Reveal Full Sea Chart", None))
        self.skip_rematch_bosses.setText(QtWidgets.QApplication.translate("MainWindow", "Skip Boss Rematches", None))
        self.add_shortcut_warps_between_dungeons.setText(QtWidgets.QApplication.translate("MainWindow", "Add Shortcut Warps Between Dungeons", None))
        self.invert_camera_x_axis.setText(QtWidgets.QApplication.translate("MainWindow", "Invert Camera X-Axis", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtWidgets.QApplication.translate("MainWindow", "Randomizer Settings", None))
        self.label_for_custom_player_model.setText(QtWidgets.QApplication.translate("MainWindow", "Player Model", None))
        self.player_in_casual_clothes.setText(QtWidgets.QApplication.translate("MainWindow", "Casual Clothes", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtWidgets.QApplication.translate("MainWindow", "Cosmetic", None))
        self.label_4.setText(QtWidgets.QApplication.translate("MainWindow", "Permalink (copy paste to share your settings):", None))
        self.update_checker_label.setText(QtWidgets.QApplication.translate("MainWindow", "Checking for updates to the randomizer...", None))
        self.about_button.setText(QtWidgets.QApplication.translate("MainWindow", "About", None))
        self.reset_settings_to_default.setText(QtWidgets.QApplication.translate("MainWindow", "Reset All Settings to Default", None))
        self.randomize_button.setText(QtWidgets.QApplication.translate("MainWindow", "Randomize", None))

        self.plando_text_label.setText(QtWidgets.QApplication.translate("MainWindow", "Plando Text File", None))
